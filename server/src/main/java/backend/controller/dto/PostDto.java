...
public class PostDto {
    ...
    public PostReadResponse toReadResponse(List<VoteResponse> votes, List<CategoryResponse> categoryResponses , Long voteResult, Boolean isScraped, Boolean isLiked) {
